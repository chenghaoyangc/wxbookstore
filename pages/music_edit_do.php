...
$sql="UPDATE chy_music SET ccid=$class_cid,musicname='".$musicname."',singer='".$singer."',
composer='".$composer."',price=$price,writer='".$writer."',words='".$words."',dt=$dt WHERE id=$id";
